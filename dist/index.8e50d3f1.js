...
(async function() {
    ...
    const myChart = new (0, _autoDefault.default)(document.getElementById("expenses"), {
        type: "bar",
        data: {
...
function animateTotalAmount(timestamp) {
    ...
    if (progress < 1) requestAnimationFrame(animateTotalAmount);
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cCUpz","dF3Ha"], "dF3Ha", "parcelRequire2ea8")
